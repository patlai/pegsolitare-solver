/**
 * Created by patricklai on 2016-03-27.
 */
class HiRiQ
{
    //int is used to reduce storage to a minimum...
    
    //config is written as a base 10 integer, but when converted to base 2 represents
    //an array of binaries where 1 = blank and 0 = filled
    //weight represents whether the first square is filled or not.
    //negative configs are the same as positive ones but the last square is empty for all of them
    public int config;
    public byte weight;
    ...
    boolean IsSolved()
    {
        //will return true if config is 2^15 and weight is 1
